...
document.getElementById('moonifyBtn').addEventListener('click', async () => {
  if (!uploadedFilePath) return alert('Please upload an image.');
  ...
  if (!imageUrl) return alert('Generation failed.');
